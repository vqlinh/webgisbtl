...
<html>
    ...
    <button type="button" class="btn btn-primary" name="login" ><a href="login.php" >Đăng Nhập</a></button>
    <button type="button" class="btn btn-success" name="regis" ><a href="register.php">Đăng ký</a></button>
        <table>
            <tr>
                <td>
