<?php
    ...
    {
        $mySQLStr = "SELECT * FROM \"cmr_locations_popest2015\"";
    ...
    {
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"cmr_locations_popest2015\"";
        $result = query($paPDO, $mySQLStr);
    ...
    function example3($paPDO,$paSRID,$paPoint)
    {
        ...
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"cmr_locations_popest2015\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        echo $mySQLStr;
        echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
    ...
    function getInfoCMRToAjax($paPDO,$paSRID,$paPoint)
    {
        ...
        $mySQLStr = "SELECT id_1, shape_leng, shape_area from \"cmr_locations_popest2015\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        //echo $mySQLStr;
        //echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
