<?php
    ...
    {
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"linehn\"";
        $result = query($paPDO, $mySQLStr);
    ...
    function example3($paPDO,$paSRID,$paPoint)
    {
        ...
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"linehn\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        echo $mySQLStr;
        echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
    ...
    function getGeoCMRToAjax($paPDO)
    {
        ...
        //echo $paPoint;
        //echo "<br>";
        //$mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"cmr_adm1\" where ST_Within('SRID=4326;POINT(12 5)'::geom)";
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"linehn\" where ";
        //echo $mySQLStr;
        //echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
    ...
    function getInfoCMRToAjax($paPDO,$paSRID,$paPoint)
    {
        ...
        $mySQLStr = "SELECT id_1, shape_leng, shape_area from \"linehn\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        //echo $mySQLStr;
        //echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
