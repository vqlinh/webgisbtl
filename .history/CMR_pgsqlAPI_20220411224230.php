<?php
    ...
    function getSearch($search)
    {
        ...
        $paPDO = initDB();
            $mySQLStr = "SELECT  pointhn.name_p ,  pointhn.location_p
                from  \"pointhn\" 
                where pointhn.name_p like '%$search%'";
            //echo $mySQLStr;
            //echo "<br><br>";
            $result = query($paPDO, $mySQLStr);
  ...
  <tbody>'; 
             ...
             foreach ($result as $value){
                <tr>
                    <th scope="row">.$result[0]['name_p']</th>
                    <td>$result[0]['location_p']</td>
                </tr>
                 $resFin = $resFin.'<tr>
                 <th scope="row">.$result[0]['name_p']</th>';
                 $resFin = $resFin.'<td>$result[0]['location_p']</td>
                 </tr>';
            //     $resFin = $resFin.'<br>'; 
             }
             $resFin = $resFin.'</tbody>
