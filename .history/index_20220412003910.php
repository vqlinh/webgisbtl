                    ...
                    <div>
                        <div>
                            ...
                            <form method="POST">
                                ...
                                <input type="submit" name="submitAll" value="click" >    
                            </form>
                        </div>
                        <br>
                        <form method="POST">
                            ...
                            <br>
                            <input type="checkbox" name="showPoint" id="showPoint"> Hiện thị các bãi đậu xe 
                            <br>
                            <input type="checkbox" name="showAll" id="showAll">  Hiện thị thông tin các bãi đậu xe
                        </form>
                        <div id="info"></div>
                    </div>   
                </td>
